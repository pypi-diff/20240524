# Comparing `tmp/adadpython-0.1.0.tar.gz` & `tmp/adadpython-0.1.1.tar.gz`

## Comparing `adadpython-0.1.0.tar` & `adadpython-0.1.1.tar`
...
### Comparing `adadpython-0.1.0/src/adadpython/base_pokemon.py` & `adadpython-0.1.1/src/adadpython/base_pokemon.py`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/dexpoke.py` & `adadpython-0.1.1/src/adadpython/dexpoke.py`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/moves.py` & `adadpython-0.1.1/src/adadpython/moves.py`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/pokemon.py` & `adadpython-0.1.1/src/adadpython/pokemon.py`
...
### Comparing `adadpython-0.1.0/src/adadpython/save2.npy` & `adadpython-0.1.1/src/adadpython/save2.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/saved_dexpoke.npy` & `adadpython-0.1.1/src/adadpython/saved_dexpoke.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/saved_movedex.npy` & `adadpython-0.1.1/src/adadpython/saved_movedex.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/somemons.dat` & `adadpython-0.1.1/src/adadpython/somemons.dat`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/texter.py` & `adadpython-0.1.1/src/adadpython/texter.py`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/trainerai.py` & `adadpython-0.1.1/src/adadpython/trainerai.py`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/victoryroad.py` & `adadpython-0.1.1/src/adadpython/victoryroad.py`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/LICENSES/numpy_license.txt` & `adadpython-0.1.1/src/adadpython/LICENSES/numpy_license.txt`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/LICENSES/python_license.txt` & `adadpython-0.1.1/src/adadpython/LICENSES/python_license.txt`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/CREDITS.txt` & `adadpython-0.1.1/src/adadpython/documentation/CREDITS.txt`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/game_blurb.md` & `adadpython-0.1.1/src/adadpython/documentation/game_blurb.md`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/log.md` & `adadpython-0.1.1/src/adadpython/documentation/log.md`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/archive/moremon.py` & `adadpython-0.1.1/src/adadpython/documentation/archive/moremon.py`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/archive/saved_dexpoke.npy` & `adadpython-0.1.1/src/adadpython/documentation/archive/saved_dexpoke.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/archive/saved_movedex.npy` & `adadpython-0.1.1/src/adadpython/documentation/archive/saved_movedex.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/archive/saved_natures.npy` & `adadpython-0.1.1/src/adadpython/documentation/archive/saved_natures.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/documentation/archive/somemons_copy.txt` & `adadpython-0.1.1/src/adadpython/documentation/archive/somemons_copy.txt`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/elite5/elite_1.npy` & `adadpython-0.1.1/src/adadpython/elite5/elite_1.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/elite5/elite_2.npy` & `adadpython-0.1.1/src/adadpython/elite5/elite_2.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/elite5/elite_3.npy` & `adadpython-0.1.1/src/adadpython/elite5/elite_3.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/elite5/elite_4.npy` & `adadpython-0.1.1/src/adadpython/elite5/elite_4.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/elite5/elite_5.npy` & `adadpython-0.1.1/src/adadpython/elite5/elite_5.npy`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/src/adadpython/somemons/somemons.dat` & `adadpython-0.1.1/src/adadpython/somemons/somemons.dat`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/LICENSE` & `adadpython-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/README.md` & `adadpython-0.1.1/README.md`

 * *Files identical despite different names*

### Comparing `adadpython-0.1.0/pyproject.toml` & `adadpython-0.1.1/pyproject.toml`
...
### Comparing `adadpython-0.1.0/PKG-INFO` & `adadpython-0.1.1/PKG-INFO`
