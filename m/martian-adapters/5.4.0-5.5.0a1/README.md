# Comparing `tmp/martian_adapters-5.4.0.tar.gz` & `tmp/martian_adapters-5.5.0a1.tar.gz`
...
### Comparing `martian_adapters-5.4.0/LICENSE` & `martian_adapters-5.5.0a1/LICENSE`
