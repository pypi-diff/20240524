# Comparing `tmp/mia_vgg-0.0.2.tar.gz` & `tmp/mia_vgg-0.0.3.tar.gz`
...
## Comparing `mia_vgg-0.0.2.tar` & `mia_vgg-0.0.3.tar`
...
### Comparing `mia_vgg-0.0.2/PKG-INFO` & `mia_vgg-0.0.3/PKG-INFO`
...
### Comparing `mia_vgg-0.0.2/pyproject.toml` & `mia_vgg-0.0.3/pyproject.toml`
...
### Comparing `mia_vgg-0.0.2/src/mia_vgg/train_target.py` & `mia_vgg-0.0.3/src/mia_vgg/train_target.py`
...
### Comparing `mia_vgg-0.0.2/src/mia_vgg.egg-info/PKG-INFO` & `mia_vgg-0.0.3/src/mia_vgg.egg-info/PKG-INFO`
