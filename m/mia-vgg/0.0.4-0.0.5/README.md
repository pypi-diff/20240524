# Comparing `tmp/mia_vgg-0.0.4.tar.gz` & `tmp/mia_vgg-0.0.5.tar.gz`
...
## Comparing `mia_vgg-0.0.4.tar` & `mia_vgg-0.0.5.tar`
...
### Comparing `mia_vgg-0.0.4/PKG-INFO` & `mia_vgg-0.0.5/PKG-INFO`
...
### Comparing `mia_vgg-0.0.4/pyproject.toml` & `mia_vgg-0.0.5/pyproject.toml`
...
### Comparing `mia_vgg-0.0.4/src/mia_vgg/train_target.py` & `mia_vgg-0.0.5/src/mia_vgg/train_target.py`
...
### Comparing `mia_vgg-0.0.4/src/mia_vgg.egg-info/PKG-INFO` & `mia_vgg-0.0.5/src/mia_vgg.egg-info/PKG-INFO`
