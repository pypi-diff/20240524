# Comparing `tmp/cadproxdk-2.9.tar.gz` & `tmp/cadproxdk-3.tar.gz`
...
## Comparing `cadproxdk-2.9.tar` & `cadproxdk-3.tar`
...
### Comparing `cadproxdk-2.9/PKG-INFO` & `cadproxdk-3/PKG-INFO`
...
### Comparing `cadproxdk-2.9/README.md` & `cadproxdk-3/README.md`

 * *Files identical despite different names*

### Comparing `cadproxdk-2.9/app/main.py` & `cadproxdk-3/app/main.py`

 * *Files identical despite different names*

### Comparing `cadproxdk-2.9/app/utils.py` & `cadproxdk-3/app/utils.py`

 * *Files identical despite different names*

### Comparing `cadproxdk-2.9/cadproxdk.egg-info/PKG-INFO` & `cadproxdk-3/cadproxdk.egg-info/PKG-INFO`
...
### Comparing `cadproxdk-2.9/setup.py` & `cadproxdk-3/setup.py`
