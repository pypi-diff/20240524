# Comparing `tmp/gauge-api-steps-0.18.tar.gz` & `tmp/gauge-api-steps-0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gauge-api-steps-0.18.tar", last modified: Fri May 24 09:42:00 2024, max compression
+gzip compressed data, was "gauge-api-steps-0.9.tar", last modified: Mon Jul 31 14:43:38 2023, max compression
```

## Comparing `gauge-api-steps-0.18.tar` & `gauge-api-steps-0.9.tar`

### file list

```diff
@@ -1,21 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-24 09:42:00.378098 gauge-api-steps-0.18/
--rw-r--r--   0 runner    (1001) docker     (127)     1088 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/LICENCE
--rw-r--r--   0 runner    (1001) docker     (127)     6384 2024-05-24 09:42:00.378098 gauge-api-steps-0.18/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     5871 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-24 09:42:00.378098 gauge-api-steps-0.18/gauge_api_steps/
--rw-r--r--   0 runner    (1001) docker     (127)       63 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/gauge_api_steps/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    16878 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/gauge_api_steps/api_steps.py
--rw-r--r--   0 runner    (1001) docker     (127)      379 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/gauge_api_steps/file_util.py
--rw-r--r--   0 runner    (1001) docker     (127)     1912 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/gauge_api_steps/reporting.py
--rw-r--r--   0 runner    (1001) docker     (127)     2485 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/gauge_api_steps/session.py
--rw-r--r--   0 runner    (1001) docker     (127)     3737 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/gauge_api_steps/substitute.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-24 09:42:00.378098 gauge-api-steps-0.18/gauge_api_steps.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     6384 2024-05-24 09:42:00.000000 gauge-api-steps-0.18/gauge_api_steps.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      445 2024-05-24 09:42:00.000000 gauge-api-steps-0.18/gauge_api_steps.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-24 09:42:00.000000 gauge-api-steps-0.18/gauge_api_steps.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-24 09:42:00.000000 gauge-api-steps-0.18/gauge_api_steps.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (127)       56 2024-05-24 09:42:00.000000 gauge-api-steps-0.18/gauge_api_steps.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-05-24 09:42:00.000000 gauge-api-steps-0.18/gauge_api_steps.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)       48 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-24 09:42:00.378098 gauge-api-steps-0.18/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      865 2024-05-24 09:41:51.000000 gauge-api-steps-0.18/setup.py
...
### Comparing `gauge-api-steps-0.18/LICENCE` & `gauge-api-steps-0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `gauge-api-steps-0.18/gauge_api_steps/api_steps.py` & `gauge-api-steps-0.9/gauge_api_steps/api_steps.py`
...
### Comparing `gauge-api-steps-0.18/setup.py` & `gauge-api-steps-0.9/setup.py`
