# Comparing `tmp/goit-phone-book-bot-0.0.5.tar.gz` & `tmp/goit-phone-book-bot-0.0.6.tar.gz`
...
## Comparing `goit-phone-book-bot-0.0.5.tar` & `goit-phone-book-bot-0.0.6.tar`
...
### Comparing `goit-phone-book-bot-0.0.5/LICENSE` & `goit-phone-book-bot-0.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `goit-phone-book-bot-0.0.5/PKG-INFO` & `goit-phone-book-bot-0.0.6/PKG-INFO`
...
### Comparing `goit-phone-book-bot-0.0.5/goit_phone_book_bot.egg-info/PKG-INFO` & `goit-phone-book-bot-0.0.6/goit_phone_book_bot.egg-info/PKG-INFO`
...
### Comparing `goit-phone-book-bot-0.0.5/goit_phone_book_bot.egg-info/SOURCES.txt` & `goit-phone-book-bot-0.0.6/goit_phone_book_bot.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `goit-phone-book-bot-0.0.5/setup.py` & `goit-phone-book-bot-0.0.6/setup.py`
...
### Comparing `goit-phone-book-bot-0.0.5/src/classes/notes_book.py` & `goit-phone-book-bot-0.0.6/src/classes/notes_book.py`

 * *Files identical despite different names*

### Comparing `goit-phone-book-bot-0.0.5/src/constants/commands.py` & `goit-phone-book-bot-0.0.6/src/constants/commands.py`

 * *Files identical despite different names*

### Comparing `goit-phone-book-bot-0.0.5/src/main.py` & `goit-phone-book-bot-0.0.6/src/main.py`
...
### Comparing `goit-phone-book-bot-0.0.5/src/utils/utils.py` & `goit-phone-book-bot-0.0.6/src/utils/utils.py`
