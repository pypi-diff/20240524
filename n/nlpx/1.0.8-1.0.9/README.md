# Comparing `tmp/nlpx-1.0.8.tar.gz` & `tmp/nlpx-1.0.9.tar.gz`
...
## Comparing `nlpx-1.0.8.tar` & `nlpx-1.0.9.tar`
...
### Comparing `nlpx-1.0.8/PKG-INFO` & `nlpx-1.0.9/PKG-INFO`
...
### Comparing `nlpx-1.0.8/nlpx/models/_text_cnn.py` & `nlpx-1.0.9/nlpx/models/_text_cnn.py`

 * *Files identical despite different names*

### Comparing `nlpx-1.0.8/nlpx/models/_trainer.py` & `nlpx-1.0.9/nlpx/models/_trainer.py`
...
### Comparing `nlpx-1.0.8/nlpx/text_token.py` & `nlpx-1.0.9/nlpx/text_token.py`

 * *Files identical despite different names*

### Comparing `nlpx-1.0.8/nlpx.egg-info/PKG-INFO` & `nlpx-1.0.9/nlpx.egg-info/PKG-INFO`
...
### Comparing `nlpx-1.0.8/setup.py` & `nlpx-1.0.9/setup.py`
