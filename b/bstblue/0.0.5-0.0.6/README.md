# Comparing `tmp/bstblue-0.0.5.tar.gz` & `tmp/bstblue-0.0.6.tar.gz`
...
## Comparing `bstblue-0.0.5.tar` & `bstblue-0.0.6.tar`
...
### Comparing `bstblue-0.0.5/PKG-INFO` & `bstblue-0.0.6/PKG-INFO`
...
### Comparing `bstblue-0.0.5/setup.cfg` & `bstblue-0.0.6/setup.cfg`
...
### Comparing `bstblue-0.0.5/src/bstblue.egg-info/PKG-INFO` & `bstblue-0.0.6/src/bstblue.egg-info/PKG-INFO`
