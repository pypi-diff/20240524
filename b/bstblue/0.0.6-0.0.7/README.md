# Comparing `tmp/bstblue-0.0.6.tar.gz` & `tmp/bstblue-0.0.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "bstblue-0.0.6.tar", last modified: Fri May 24 08:18:34 2024, max compression
+gzip compressed data, was "bstblue-0.0.7.tar", last modified: Fri May 24 08:39:01 2024, max compression
```

## Comparing `bstblue-0.0.6.tar` & `bstblue-0.0.7.tar`

### file list

```diff
@@ -1,16 +1,15 @@
-drwxrwxrwx   0        0        0        0 2024-05-24 08:18:34.674275 bstblue-0.0.6/
--rw-rw-rw-   0        0        0        0 2024-05-23 13:29:33.000000 bstblue-0.0.6/LICENSE
--rw-rw-rw-   0        0        0      654 2024-05-24 08:18:34.673283 bstblue-0.0.6/PKG-INFO
--rw-rw-rw-   0        0        0      159 2024-05-24 07:58:37.000000 bstblue-0.0.6/README.md
--rw-rw-rw-   0        0        0      103 2024-05-23 13:32:24.000000 bstblue-0.0.6/pyproject.toml
--rw-rw-rw-   0        0        0      632 2024-05-24 08:18:34.679269 bstblue-0.0.6/setup.cfg
-drwxrwxrwx   0        0        0        0 2024-05-24 08:18:34.608469 bstblue-0.0.6/src/
-drwxrwxrwx   0        0        0        0 2024-05-24 08:18:34.643360 bstblue-0.0.6/src/bstblue/
--rw-rw-rw-   0        0        0        0 2024-05-23 13:48:24.000000 bstblue-0.0.6/src/bstblue/__init__.py
--rw-rw-rw-   0        0        0      773 2024-05-24 08:17:58.000000 bstblue-0.0.6/src/bstblue/bstblue.py
--rw-rw-rw-   0        0        0      438 2024-05-24 08:17:54.000000 bstblue-0.0.6/src/bstblue/wbdev.py
-drwxrwxrwx   0        0        0        0 2024-05-24 08:18:34.671283 bstblue-0.0.6/src/bstblue.egg-info/
--rw-rw-rw-   0        0        0      654 2024-05-24 08:18:34.000000 bstblue-0.0.6/src/bstblue.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      250 2024-05-24 08:18:34.000000 bstblue-0.0.6/src/bstblue.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-24 08:18:34.000000 bstblue-0.0.6/src/bstblue.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        8 2024-05-24 08:18:34.000000 bstblue-0.0.6/src/bstblue.egg-info/top_level.txt
...
### Comparing `bstblue-0.0.6/PKG-INFO` & `bstblue-0.0.7/PKG-INFO`
...
### Comparing `bstblue-0.0.6/setup.cfg` & `bstblue-0.0.7/setup.cfg`
...
### Comparing `bstblue-0.0.6/src/bstblue.egg-info/PKG-INFO` & `bstblue-0.0.7/src/bstblue.egg-info/PKG-INFO`
