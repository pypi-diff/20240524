# Comparing `tmp/bstblue-0.0.3.tar.gz` & `tmp/bstblue-0.0.4.tar.gz`
...
## Comparing `bstblue-0.0.3.tar` & `bstblue-0.0.4.tar`
...
### Comparing `bstblue-0.0.3/setup.cfg` & `bstblue-0.0.4/setup.cfg`
