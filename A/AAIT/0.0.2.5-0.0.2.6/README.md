# Comparing `tmp/AAIT-0.0.2.5.tar.gz` & `tmp/AAIT-0.0.2.6.tar.gz`
...
## Comparing `AAIT-0.0.2.5.tar` & `AAIT-0.0.2.6.tar`
...
### Comparing `AAIT-0.0.2.5/setup.py` & `AAIT-0.0.2.6/setup.py`
